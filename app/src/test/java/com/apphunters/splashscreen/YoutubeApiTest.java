...
public class YoutubeApiTest {
    /** Application name. */
    private static final String APPLICATION_NAME = " AssigmentMobile21";
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in = MainActivity.class.getResourceAsStream("/client_secret.json");
